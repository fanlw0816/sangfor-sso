package com.sangfor.base.config.shiro;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
		...
		List<com.sangfor.base.entity.Resource> list = resourceService.findAll();
		for (com.sangfor.base.entity.Resource resource : list) {
